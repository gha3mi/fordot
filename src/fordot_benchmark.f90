...
contains
   ...
   !> author: Seyed Ali Ghasemi
   subroutine stop_benchmark(t,m,n,o,nloops,Sc,Sc_ref,method,filename)
      ...
      if (this_image() == 1) then
         ...
         print'(a,3e13.6)', ' Relative err.: ', abs(Sc_ref-Sc)/abs(Sc_ref)
